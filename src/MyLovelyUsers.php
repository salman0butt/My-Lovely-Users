...
class MyLovelyUsers
{
     ...
     *
     * @param EndpointRegistrationInterface $endpointRegistration
     *        An instance of EndpointRegistrationInterface to register the plugin's endpoint.
     * @param SettingInterface $setting
     *        An instance of SettingInterface to manage the plugin's settings.
     * @param UserTableInterface $usersTable
     *        An instance of UserTableInterface to render the plugin's user table.
     * @param UserDetailsInterface $userDetails
     *        An instance of UserDetailsInterface to render a single user's details.
     * @param UserTableShortcodeInterface $userTableShortcode
     *        An instance of UserTableShortcodeInterface to render a single user's details.
     * @param LoggerInterface $logger
     *        An instance of LoggerInterface to log.
     */
    public function __construct(
        ...
        $this->pluginName = defined('MY_LOVELY_USERS_NAME') ?
        MY_LOVELY_USERS_NAME :
